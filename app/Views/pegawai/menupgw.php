        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                <div class="row justify-content-end mb-3">
                    <button onclick="window.location.href='<?= base_url('add_data_menupgw') ?>'" class="btn btn-primary mr-3">Tambah Menu</button>
                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="<?= base_url('menupgw/update'); ?>" method="post" enctype="multipart/form-data">
    ...
    <script>
        $(document).ready(function() {
            $('.delete-button').click(function() {
                ...
                var deleteUrl = '<?= base_url('menupgw/') ?>' + idMenu;
