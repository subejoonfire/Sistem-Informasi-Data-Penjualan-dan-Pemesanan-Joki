                ...
                <?php foreach ($menu as $m) : ?>
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product">
                            ...
                            <a href="#" class="img-prod"><img class="img-fluid" src="<?= $m['gambar'] ?>" alt="<?= $m['nama'] ?>" alt="Colorlib Template">
                            ...
                            <div class="text py-3 pb-4 px-3 text-center">
                                ...
                                <div class="bottom-area d-flex px-3">
                                    <div class="m-auto d-flex">
                                        <a href="<?= base_url('cart/' . $m['id_menu']); ?>" class="buy-now d-flex justify-content-center align-items-center mx-1">
