...
<head>
  <style>
    ...
    .navbar-brand-wrapper .navbar-brand img {
      ...
      height: auto;
      /* Biarkan tinggi disesuaikan dengan lebar */
    }

    .navbar-brand-wrapper .navbar-brand {
      margin-right: 50px;
      /* Geser ke kanan sejauh 20px */
    }
  </style>
  <!-- Required meta tags -->
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="/"><img src="assets/images/hanyar.png" class="mr-2" alt="logo" /></a>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              ...
              <a class="dropdown-item" href="login" id="logoutLink">
